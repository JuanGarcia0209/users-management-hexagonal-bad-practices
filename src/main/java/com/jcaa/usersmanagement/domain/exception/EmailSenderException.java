...
public final class EmailSenderException extends DomainException {
  ...
  private static final String SMTP_ERROR_FORMAT = "No se pudo enviar el correo a '%s'. Error SMTP: %s";
  ...
  public static EmailSenderException becauseSmtpFailed(
    ...
    return new EmailSenderException(String.format(SMTP_ERROR_FORMAT, destinationEmail, smtpError));
  }
